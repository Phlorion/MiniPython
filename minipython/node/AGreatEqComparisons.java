...
public final class AGreatEqComparisons extends PComparisons
{
    private PExpression _lexpr_;
    private PExpression _rexpr_;

    public AGreatEqComparisons()
    {
    }
    ...
    public Object clone()
    {
        return new AGreatEqComparisons(
    ...
    {
        ((Analysis) sw).caseAGreatEqComparisons(this);
    }
