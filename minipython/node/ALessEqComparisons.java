...
public final class ALessEqComparisons extends PComparisons
{
    private PExpression _lexpr_;
    private PExpression _rexpr_;

    public ALessEqComparisons()
    {
    }
    ...
    {
        ((Analysis) sw).caseALessEqComparisons(this);
    }
