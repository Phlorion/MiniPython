...
public final class AMultiplicationAddition extends PAddition
{
    private PMultiplication _multiplication_;

    public AMultiplicationAddition()
    {
    }
    ...
    public Object clone()
    {
        return new AMultiplicationAddition(
            (PMultiplication) cloneNode(_multiplication_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMultiplicationAddition(this);
    }
