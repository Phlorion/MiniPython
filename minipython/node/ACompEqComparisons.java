...
public final class ACompEqComparisons extends PComparisons
{
    private PExpression _lexpr_;
    private PExpression _rexpr_;

    public ACompEqComparisons()
    {
    }
    ...
    {
        ((Analysis) sw).caseACompEqComparisons(this);
    }
