...
public final class AFuntionCallExpression extends PExpression
{
    private PFunctionCall _functionCall_;

    public AFuntionCallExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AFuntionCallExpression(
            (PFunctionCall) cloneNode(_functionCall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFuntionCallExpression(this);
    }
