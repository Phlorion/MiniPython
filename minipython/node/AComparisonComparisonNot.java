...
public final class AComparisonComparisonNot extends PComparisonNot
{
    private PComparison _comparison_;

    public AComparisonComparisonNot()
    {
    }
    ...
    public Object clone()
    {
        return new AComparisonComparisonNot(
            (PComparison) cloneNode(_comparison_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAComparisonComparisonNot(this);
    }
